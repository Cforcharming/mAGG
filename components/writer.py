...
def write_topology_file(list_services,
    ...
    topology_writing_path = os.path.join(example_result_path, folder_name, "topology.json")
...
def copy_vulnerability_file(clairctl_home, image_name, old_root_path, parent_folder):
    ...
    os.rename(os.path.join(clairctl_home,
                           ...
                           + image_name
                           + "-latest.json"),
              get_json_name(old_root_path, config, parent_folder, image_name))


def get_json_name(old_root_path, config, parent_folder, image_name):
    return os.path.join(old_root_path,
