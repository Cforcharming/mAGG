...
def scalability_test_helper(example_folder):
    ...
    config = None
    no_topology_nodes = None
    no_topology_edges = None
    no_attack_graph_nodes = None
    no_attack_graph_edges = None
    ...
    for i in range(1, number_runs_per_test + 1):
        ...
        topology, duration_topology_new = topology_parser.parse_topology(example_folder,
                                                                         os.getcwd())
    ...
    writer.print_summary(config["mode"],
                         ...
                         duration_vulnerabilities_preprocessing=duration_vuls_preprocessing,
...
class MyTest(unittest.TestCase):
    ...
    def test_bfs_privileged_exists(self):
        """Testing the creation of attack graph with a privileged container.
        Here the privileged container is container2. Container3 is isolated, and it can
        only be reached through the docker host."""
        
        print("Test: Testing an image with a 'privileged' flag...")
    ...
    def test_bfs_privileged_not_exist(self):
        """Testing the creation of attack graph without a privileged container.
    ...
    def test_more_than_one_vuls(self):
        """Tests an attack graph that has more than two ways to attack
    ...
    def test_long_attack_graph(self):
        ...
        The attacker has to obtain outside->container1->container2->container3->container4"""
